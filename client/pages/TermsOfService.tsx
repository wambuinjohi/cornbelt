...
export default function TermsOfService() {
  useEffect(() => {
    useUpdateMetaTags({
      ...
      ogTitle: pageMetadata.terms.title,
      ogDescription: pageMetadata.terms.description,
      ogUrl: "https://cornbelt.co.ke/terms-of-service",
      canonicalUrl: "https://cornbelt.co.ke/terms-of-service",
      twitterCard: "summary",
    });
  }, []);
          ...
          <div className="container mx-auto px-4 md:px-6 py-12 md:py-16">
            <div className="max-w-3xl mx-auto">
              ...
              <div className="prose prose-invert max-w-none space-y-6 text-foreground">
                ...
                <section>
                  <h2 className="text-2xl font-bold text-foreground mb-3">
                    10. Product Ordering and Payment
                  </h2>
                  <p className="text-muted-foreground leading-relaxed mb-3">
                  ...
                  <ul className="list-disc list-inside space-y-2 text-muted-foreground">
                    ...
                    <li>
                      ...
                      appears to be fraudulent or suspicious
                    </li>
                    <li>
                      Prices are subject to change without notice and are only
                ...
                <section>
                  ...
                  <ul className="list-disc list-inside space-y-2 text-muted-foreground">
                    ...
                    <li>To harass, threaten, or defame any person</li>
                    <li>To send spam or unsolicited communications</li>
                    <li>To upload viruses or malicious code</li>
                    <li>
                      To interfere with or disrupt the website or its services
                    </li>
