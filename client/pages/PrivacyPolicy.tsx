            ...
            <div className="prose prose-invert max-w-none space-y-6 text-foreground">
              <section>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Cornbelt Flour Mill Limited ("we," "our," or "us") is
              ...
              <section>
                ...
                <ul className="list-disc list-inside space-y-2 text-muted-foreground">
                  <li>
                    ...
                    number, mailing address, and payment information when you
                  ...
                  <li>
                    <strong>Cookies and Tracking:</strong> Data collected
              ...
              <section>
                ...
                <ul className="list-disc list-inside space-y-2 text-muted-foreground">
                  ...
                  <li>
                    To send you promotional emails and marketing materials
                  </li>
              ...
              <section>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  We may disclose your information when required by law or when
                  we believe in good faith that such disclosure is necessary to:
                  protect our rights, your safety, or the safety of others;
                  enforce our Terms of Service; or prevent fraud. We do not
                  sell, trade, or transfer your personally identifiable
                  information to outside parties without your consent, except as
                  necessary to process your transactions or as required by law.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  to enhance your experience. These technologies help us
              ...
              <section>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  policies of any third-party websites before providing your
              ...
              <section>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  Policy on our website and updating the "Last updated" date at
                  the top of this page. Your continued use of the website
